package az.asaf.ma_sme_compose.ui.utils
...
internal class ViewInteropNestedScrollConnection(
    ...
    override suspend fun onPreFling(available: Velocity): Velocity {
        ...
        if (viewHelper.hasNestedScrollingParent(ViewCompat.TYPE_TOUCH)) {
            viewHelper.stopNestedScroll(ViewCompat.TYPE_TOUCH)
        } else if (viewHelper.hasNestedScrollingParent(ViewCompat.TYPE_NON_TOUCH)) {
            viewHelper.stopNestedScroll(ViewCompat.TYPE_NON_TOUCH)
        }
...
private fun NestedScrollSource.toViewType(): Int = when (this) {
    NestedScrollSource.Drag -> ViewCompat.TYPE_TOUCH
    else -> ViewCompat.TYPE_NON_TOUCH
}
